...
async def shutdown_bot(event):
    ...
    if BOTLOG_CHATID:
        await event.client.send_message(
            BOTLOG_CHATID,
            "**#SHUTDOWN** \n"
            "**Gemoy Userbot** telah di matikan!\nJika ingin menghidupkan kembali silahkan buka heroku",
        )
    await edit_or_reply(event, "**Gemoy Userbot Berhasil di matikan!**")
...
async def restart_bot(event):
    if event.sender_id in SUDO_USERS:
        return
    await edit_or_reply(event, "**Gemoy Userbot Berhasil di Restart**")
    if BOTLOG_CHATID:
        await event.client.send_message(
            BOTLOG_CHATID, "#RESTART \n" "**Gemoy Userbot Berhasil Di Restart**"
        )
...
async def reedme(event):
    await edit_or_reply(
        ...
        "\n┌✪ [Userbot Repo](https://github.com/nndaanda/Gemoy-Userbot/blob/Gemoy-Userbot/README.md)"
...
async def repo_is_here(event):
    ...
    await xx.edit(
        "**Usᴇʀʙᴏᴛ Tᴇʟᴇɢʀᴀᴍ**\n"
        "𝗥𝗲𝗽𝗼 🇮🇩\n"
        "╰⎆ [Gemoy-Userbot​](https://github.com/nndaanda/Gemoy-Userbot)\n"
        "✪ **Oᴡɴᴇʀ​** ⎆ [Grey](t.me/greyyvbss)\n"
        "✪ **Sᴜᴘᴘᴏʀᴛ**​ ⎆ [groups](t.me/gemoysupport)\n"
    )
...
async def string_is_here(event):
    await edit_or_reply(
        ...
        "**List Bot**\n"
        "\n┌✪ **GET STRING BOT:**"
        "\n└✪ [[ KLIK DISINI ]](https://t.me/StringCilik_bot)",
    )
